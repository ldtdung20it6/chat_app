...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/dung/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/dung/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/com/dung/icon/file.png")).getImage();
    }
