...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/dung/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/dung/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.dung.swing.JIMSendTextPane();
    ...
    private com.dung.swing.JIMSendTextPane txt;
